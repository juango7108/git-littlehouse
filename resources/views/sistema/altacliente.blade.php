...
@endif	
Apellido(s)</td><td><input type = 'text' name  ='apellidos' value="{{old('apellidos')}}">
</td></tr>
...
@endif	
Dirección</td><td><input type  ='text' name ='direccion' value="{{old('direccion')}}">
</td></tr>
...
<i> {{ $errors->first('cp') }} </i> 
@endif	
Codigo Postal</td><td> <input type = 'text'name = 'cp' value="{{old('cp')}}" >
</td></tr>
...
@endif	
Telefono </td><td><input type = 'text'name = 'tel' value="{{old('tel')}}" >
</td></tr>
...
@endif	
Correo</td><td><input type = 'correo'name = 'correo' value="{{old('correo')}}" >
</td></tr>
<tr><td>
